...
def insert_bank(self):
    with open('C:\\Users\\ankur\\OneDrive\\Desktop\\djangoProject\\ankur\\Scripts\\project41\\app\\bank.csv', 'r') as FO:
        IOD=csv.reader(FO)
        for i in IOD:
            bn=i[0].strip()
...
def insert_branch(self):
    with open('C:\\Users\\ankur\\OneDrive\\Desktop\\djangoProject\\ankur\\Scripts\\project41\\app\\branch1.csv') as FO:
        IOD=csv.reader(FO)
        next(IOD)
        for i in IOD:
            bn=i[0]
